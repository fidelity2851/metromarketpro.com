...
<form wire:submit.prevent="CreateNewUser()" method="POST" class="modal-content">
    <div class="modal-header">
        <h5 class="acct_modal_header" id="staticBackdropLabel">CREATE CLIENTS </h5>
    ...
    <div class="modal-footer">
        ...
        <button wire:loading wire:target="CreateNewUser" type="button" class="acct_modal_btn disabled"
            disabled>Processing...</button>
        <button wire:loading.remove wire:target="CreateNewUser" type="submit" class="acct_modal_btn">Submit</button>
    </div>
</form>
<form wire:submit.prevent="CreateDepositMethod()" method="POST" class="modal-content">
    <div class="modal-header">
        <h5 class="acct_modal_header" id="staticBackdropLabel">Add Payment Method</h5>
        ...
        <div class="">
            ...
            <div class="d-md-flex">
                <div class="col col-md-8 mr-md-3 mb-3 px-0">
                    ...
                    <input type="number" wire:model.lazy="min_deposit" class="acct_modal_box" min="1"
                        placeholder="Eg. 100">
                    @error('min_deposit') <span class="acct_box_error">{{ $message }}</span> @enderror
                </div>
                <div class="col mb-3 px-0">
                    <label class="acct_modal_label">Deposit Fee</label>
                    <input type="number" wire:model.lazy="fee" class="acct_modal_box"
                        placeholder="Eg. 10">
    ...
    <div class="modal-footer justify-content-between">
        ...
        <button wire:loading.remove wire:target="CreateDepositMethod()" type="submit"
            class="acct_modal_btn">Submit</button>
        <button wire:loading wire:target="CreateDepositMethod()" type="button" class="acct_modal_btn disabled"

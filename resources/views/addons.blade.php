        ...
        <div class="modal-dialog">
            <form action="#" method="POST" class="modal-content">
                <div class="modal-header">
                    <h5 class="acct_modal_header" id="staticBackdropLabel">New Plugin</h5>
                ...
                <div class="modal-body">
                    <div class="">
                        ...
                        <div class="mb-3">
                            <label class="acct_modal_label">Plugin Name</label>
                            <input type="text" name="ammount" class="acct_modal_box" min="1" placeholder="Enter plugin name">
                        </div>
                        <div class="mb-3">
                            <label class="acct_modal_label">Public Key</label>
                            <input type="text" name="ammount" class="acct_modal_box" min="1" placeholder="Enter public key">
                        </div>
                        <div class="mb-3">
                            <label class="acct_modal_label">Secret Key</label>
                            <input type="text" name="ammount" class="acct_modal_box" min="1" placeholder="Enter secret key">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="acct_modal_label">Status</label>
                            <div class="">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="ref1" name="ref" class="custom-control-input">
                                    <label class="custom-control-label acct_modal_label" for="ref1">Active</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="ref2" name="ref" class="custom-control-input" checked>
                                    <label class="custom-control-label acct_modal_label" for="ref2">Inactive</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="acct_modal_btn">Submit</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="col acct_cont_con px-0">
            <div class="col acct_header_con d-flex justify-content-between align-items-center sticky-top px-3 px-sm-4">
                <div class="d-flex align-items-center">
                    ...
                    <p class="acct_header">SETTINGS</p>
                </div>
                <div class=" d-flex align-items-center">
            ...
            <div class="col py-4 px-0 px-md-3">
                ...
                <div class="col d-sm-flex justify-content-between align-items-center mb-4">
                    <p class="acct_cont_header mb-3 mb-sm-0 ">Plugins</p>
                    <button type="button" class="acct_btn2" data-toggle="modal" data-target="#staticBackdrop">New Plugin</button>
                </div>

                <div class="row mx-0">
                    <div class="col-12 col-sm-6 col-lg-4 mb-4 ">
                        <div class="col acct_pay_cont d-flex align-items-center shadow-sm mb-2">
                            <img src="images/stripe.jpg" alt="" class="acct_pay_img mr-3">
                            <div class="">
                                <p class="acct_pay_head">Strip</p>
                                <p class="acct_pay_status2">Inactive</p>
                                <a href="edit_addons.php" class="text-decoration-none">
                                    <button type="button" class="acct_pay_btn">Update</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mx-auto mx-md-0">
                        <p class="pagi_num">
                            << </p>
                                ...
                                <p class="pagi_num">4</p>
                                <p class="pagi_num">5</p>
                                <p class="pagi_num"> >> </p>
                    </div>
                </div>
